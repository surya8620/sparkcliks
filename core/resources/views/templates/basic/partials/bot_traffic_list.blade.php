...
<table class="table--responsive--lg table-bordered table-striped table">
    <thead>
        <tr>
            ...
            <th scope="col" class="text-center" style="font-size: 14px;" title="Visitors Sent">@lang('Visits Completed')</th>
    ...
    <tbody>
        @forelse ($orders as $item)
            <tr>
                ...
                <td style="font-size: 14px;">{{ showDateTime($item->created_at) }}</td>
                <td>
                    ...
                    @if ($item->status == 2 || $item->status == 5)
                        <a href="javascript:void(0)" class="action-btn edit-btn ml-1 statusBtn" title="Renew"
                            ...
                            data-url="{{ route('user.bot.renew', $item->id) }}">
                    ...
                    @elseif($item->status == 6)
                        <a href="javascript:void(0)" class="action-btn edit-btn ml-1 playBtn" title="Resume Campaign"
                            ...
                            data-url="{{ route('user.bot.resume', $item->id) }}">
                    ...
                    @elseif($item->status == 1)
                        <a href="javascript:void(0)" class="action-btn edit-btn ml-1 pauseBtn" title="Pause Campaign"
                            ...
                            data-url="{{ route('user.bot.pause', $item->id) }}">
                            <i class="fa-solid fa-pause text--green" style="font-size: 18px;"></i>
                        </a>
                    @endif
                    <a href="{{ route('user.bot.details', $item->id) }}" class="action-btn edit-btn ml-1"
                        title="Edit">
                        <i class="fa-solid fa-pen-to-square text--primary" style="font-size: 18px;"></i>
                    </a>&nbsp;
                    <a href="{{ route('user.bot.logs', $item->id) }}" class="action-btn edit-btn ml-1"
                        title="Logs">
                        <i class="fa-solid fa-list-alt text--primary" style="font-size: 18px;"></i>
                    </a>&nbsp;
