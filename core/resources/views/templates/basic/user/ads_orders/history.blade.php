                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Actions')">
                                    <a href="{{ route('user.ad.details', $item->id) }}" class="icon-btn btn--primary ml-1" title="Edit">
                                        <i class="la la-edit"></i>
                                    </a>&nbsp;
                                    <a href="{{ route('user.ad.reports', $item->id) }}" class="icon-btn btn--primary ml-1" title="Reports">
                                        <i class="las la-chart-bar"></i>
                                    </a>&nbsp;
                                    @if($item->status == 2 || $item->status == 5)
                                    <a href="javascript:void(0)" class="icon-btn btn--success ml-1 statusBtn" title="Renew" data-original-title="@lang('Renew')" data-toggle="tooltip" data-url="{{ route('user.ad.renew', $item->id) }}">
                                        <i class="las la-sync"></i>
                                    </a>
                                    @elseif($item->status == 6)
                                    <a href="javascript:void(0)" class="icon-btn btn--danger ml-1 playBtn" title="Resume Campaign" data-original-title="@lang('Resume Campaign')" data-toggle="tooltip" data-url="{{ route('user.ad.resume', $item->id) }}">
                                        <i class="las la-play"></i>
                                    </a>
                                    @elseif($item->status == 1)
                                    <a href="javascript:void(0)" class="icon-btn btn--success ml-1 pauseBtn" title="Pause Campaign" data-original-title="@lang('Pause Campaign')" data-toggle="tooltip" data-url="{{ route('user.ad.pause', $item->id) }}">
