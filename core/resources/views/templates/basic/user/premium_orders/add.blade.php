                                    ...
                                    <tr>
                                        ...
                                        <td data-label="@lang('New Campaign')">
                                            ...
                                            <a href="javascript:void(0)" class="btn  btn--primary custom-success deposi orderBtn"
                                               ...
                                               data-url="{{ route('user.premium.create', $item->id) }}"
                ...
                <form method="post" class="resetForm">
                    ...
                    <div class="modal-body">
                        ...
                        @if($user->premium_credit > 1 )
                            ...
                            <label class="font-weight-bold"><span class="text-secondary text--danger">@lang('Geo Target = 2 x Credits')</span>
                        @else
                        <label for="country" class="font-weight-bold">@lang('Select Country')</label>
				    ...
				    <option value="Worldwide" selected>Worldwide</option>
                        ...
                        <div class="input-group">
                            <div for="quantity" class="input-group-text">@lang('Total Visits')</div>  
                            <span class="form-control total_price text--success" id="info" readonly>1000</span>                          
                                <input type="range" class="form-range font-weight-bold" min="1" max="{{ ($user->premium_credit) }}" value="1" id="quantity" name="qty">
                            </div>
                        </div>
                        ...
                        <div class="form-row form-group">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control total_price text--success" name="price" value="1" min="1" max="{{ ($user->premium_credit) }}" readonly>
                                    <div class="input-group-text">@lang('Available')</div>
                                    <input type="text" class="form-control total_price text--success" value="{{ ($user->premium_credit) }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-row form-group">
                ...
                <div class="card card-deposit text-center">
                    ...
                    <div class="card-footer">
                        <div class="d-grid gap-3 col-6 mx-auto">
                            <a href="{{ route('user.premium.buy') }}" class="btn  btn--primary btn-block custom-success deposi orderBtn font-weight-bold" data-original-title="@lang('Buy Credits')">
                                Buy Credits
                            </a>
                        </div>
                    </div>
