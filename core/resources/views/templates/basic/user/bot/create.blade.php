...
@section('content')
    ...
    <div class="row g-1 g-lg-3 justify-content-center">
        @if($user->bot_credit > 0 && $user->bot_status == 1)
        <div class="col-lg-12 col-md-12 mb-4"> 
            <div class="card">
                <div class="card-header border-0 pb-0">
                    <!-- Optimized Nav Pills Tabs with Mobile Support -->
                    <ul class="nav nav-pills nav-fill campaign-tabs w-100" id="campaignTabs" role="tablist">
                ...
                <div class="card-body">
                    <form id="projectForm" action="{{ route('user.bot.store') }}" method="post">
                        @csrf
                        ...
                        <div class="tab-content" id="campaignTabContent">
                            ...
                            <div class="form-group col-12 col-md-12">
                                ...
                                <input class="form--control" name="name" placeholder="My Campaign" required>
                            </div>
                            <div class="form-group col-12 col-md-8">
                                <label class="form--label">@lang('Enter URL')
                                    ...
                                    <br><small class="text--base" style="font-size: 0.75rem;">@lang('Enter URL/URLs with HTTP or HTTPS Prefix') https://example.com</small></label>
                                <textarea class="form--control" name="urls" rows="2" placeholder="Add the Initial URLs/websites (each per line)  https://example.com" required></textarea>
                            </div>
                            <div class="form-group col-12 col-md-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="hidden" name="url_order" id="urlOrderInput" value="one_by_one">
                                </div>
                                <hr>
                                <div class="form-group">
                                    ...
                                    <select id="devices" class="form--control" name="devices">
                                        ...
                                        <option value="mobile">Mixed</option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="number" name="min_delay" class="form--control" placeholder="Min Delay" min="0" step="1" value="10">
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="form--label">@lang('Max')<small class="text--base" style="font-size: 0.75rem;">@lang(' (in seconds)')</small></label>
                                <input type="number" name="max_delay" class="form--control" placeholder="Max Delay" min="0" step="1" value="30">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="form-group col-12 col-md-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="hidden" name="referrer_enabled" id="referrer_enabled" value="0">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <button type="button" id="toggleSearch" class="btn btn--primary me-2 w-100" disabled="">Coming Soon!</button>
                                    <input type="hidden" name="search_enabled" id="search_enabled" value="0">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <textarea id="search_keywords" class="form--control" name="search_keywords" rows="3" placeholder="Add the keywords (each per line)" disabled=""></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mt-3" id="addWidgetSection" style="display: none;">
                                            <button type="button" class="btn btn--primary add-widget-btn" data-toggle="modal" data-target="#widgetModal">
                                                <i class="las la-plus"></i> @lang('Add Widget')
                                            </button>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <label class="form--label">@lang('Min')<small class="text--base" style="font-size: 0.75rem;">@lang(' (in seconds)')</small></label>
                                <input type="number" name="min_task_delay" class="form--control" placeholder="Min Delay" min="0" step="1" value="10">
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="form--label">@lang('Max')<small class="text--base" style="font-size: 0.75rem;">@lang(' (in seconds)')</small></label>
                                <input type="number" name="max_task_delay" class="form--control" placeholder="Max Delay" min="0" step="1" value="30">
                            </div>
                        </div>
                        <hr>
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        <label class="form--label">@lang('Active Browsers')
                                            <i class="las la-info-circle info-icon" data-toggle="tooltip" data-placement="top" title="Number of simultaneous browser sessions. Each active browser consumes 1 credit from your account."></i>
                                            <br><small class="text--base" style="font-size: 0.75rem;">
                                                <span class="credit-available">@lang('Available: '){{ auth()->user()->bot_credit - auth()->user()->bot_used }}</span> /
                                                <span class="credit-used">@lang('Used: '){{ auth()->user()->bot_used }}</span> /
                                                <span class="credit-total">@lang('Total: '){{ auth()->user()->bot_credit }}</span>
                                            </small></label>
                                        <input type="number" name="active_users" class="form-control me-2 w-50" placeholder="Active Browsers" min="1" max="{{ auth()->user()->bot_credit - auth()->user()->bot_used }}" value="1">
                                    </div>
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="number" name="max_visits" class="form-control me-2 w-50" placeholder="Max Visits" min="0" value="100">
                                    </div>
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="number" name="timeout" class="form-control me-2 w-50" placeholder="Max Timeout" min="0" value="60">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="advanced-content" role="tabpanel" aria-labelledby="advanced-tab">
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <textarea class="form--control" name="accept_language" rows="2" placeholder="e.g., en-US, en, fr or one per line">en-US</textarea>
                                ...
                                <hr>
                                <div class="row">
                                    <label class="form--label col-12 mb-2">@lang('Resource Configuration')</label>
                                    <div class="form-group col-12 col-md">
                                        <label class="form--label">@lang('Images')</label>
                                        <div class="d-flex align-items-center">
                                            <button type="button" id="toggleImages" class="btn btn--primary w-100">Disabled</button>
                                            <input type="hidden" name="load_images" id="load_images" value="0">
                                        </div>
                                    </div>
                                    <div class="form-group col-12 col-md">
                                        <label class="form--label">@lang('Videos')</label>
                                        <div class="d-flex align-items-center">
                                            <button type="button" id="toggleVideos" class="btn btn--primary w-100">Disabled</button>
                                            <input type="hidden" name="load_videos" id="load_videos" value="0">
                                        </div>
                                    </div>
                                    <div class="form-group col-12 col-md">
                                        <label class="form--label">@lang('CSS')</label>
                                        <div class="d-flex align-items-center">
                                            <button type="button" id="toggleCSS" class="btn btn--base w-100">Enabled</button>
                                    ...
                                    <div class="form-group col-12 col-md">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <button type="button" id="toggleFonts" class="btn btn--base w-100">Enabled</button>
                                            <input type="hidden" name="load_fonts" id="load_fonts" value="1">
                                        </div>
                                    </div>
                                    <div class="form-group col-12 col-md">
                                        <label class="form--label">@lang('Scripts (JS)')</label>
                                        <div class="d-flex align-items-center">
                                            <button type="button" id="toggleScripts" class="btn btn--base w-100">Enabled</button>
                                            <input type="hidden" name="load_scripts" id="load_scripts" value="1">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-12 col-md-6">
                                <label class="form--label">@lang('Premium Rotating Proxy')</label>
                                
                                <div class="d-flex align-items-center mb-2">
                                    <button type="button" id="toggleFreeProxy" class="btn btn--primary w-100">Disabled</button>
                                    <input type="hidden" name="free_proxy_enabled" id="free_proxy_enabled" value="0">
                                </div>
                                <select id="freeProxyInput" class="form--control" name="free_proxy_country">
                                    @include('partials.proxy-options')
                                </select>
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <button type="button" id="toggleCustomProxy" class="btn btn--base w-100">Enabled</button>
                                    <input type="hidden" name="custom_proxy_enabled" id="custom_proxy_enabled" value="1">
                                </div>
                                <small class="form--label text--base d-block mb-1" style="font-size: 0.75rem;">@lang('IP:PORT or IP:PORT:USERNAME:PASSWORD')</small>
                                <textarea id="customProxyInput" class="form--control" name="custom_proxies" rows="3" placeholder="Enter custom proxies (each per line)"></textarea>
                        ...
                        <div class="tab-navigation-buttons">
                            <!-- Tab 1 - Campaign Details Navigation -->
                            <div class="d-flex justify-content-between align-items-center tab-nav-btn-group" id="tab1-nav" style="display: flex !important;">
                                <button type="button" class="btn btn-secondary" disabled style="visibility: hidden;">
                                    <i class="las la-arrow-left"></i> @lang('Back')
                                </button>
                                <button type="button" class="btn btn--base btn-next" data-next-tab="#advanced-content">
                                    @lang('Next') <i class="las la-arrow-right"></i>
                                </button>
                            </div>

                            <!-- Tab 2 - Advanced Config Navigation -->
                            <div class="d-flex justify-content-between align-items-center tab-nav-btn-group" id="tab2-nav" style="display: none !important;">
                                <button type="button" class="btn btn-secondary btn-prev" data-prev-tab="#details-content">
                                    <i class="las la-arrow-left"></i> @lang('Back')
                                </button>
                                <button type="button" class="btn btn--base btn-next" data-next-tab="#proxy-content">
                                    @lang('Next') <i class="las la-arrow-right"></i>
                                </button>
                            </div>

                            <!-- Tab 3 - Proxy Settings Navigation (with Create button) -->
                            <div class="d-flex justify-content-between align-items-center tab-nav-btn-group" id="tab3-nav" style="display: none !important;">
                                <button type="button" class="btn btn-secondary btn-prev" data-prev-tab="#advanced-content">
                                    <i class="las la-arrow-left"></i> @lang('Back')
                                </button>
                                @if($user->bot_status != 1)
                                <button id="createButton" class="btn btn-outline--base" type="submit" disabled>
                                    <i class="las la-check-circle"></i> @lang('Create Campaign')
                                </button>
                                @else
                                <button id="createButton" class="btn btn--base" type="submit">
                                    <i class="las la-check-circle"></i> @lang('Create Campaign')
                                </button>
                                @endif
                            </div>
    ...
    (function($) {
        ...
        $(document).ready(function() {
            ...
            $('#campaignTabs a[data-toggle="pill"], #campaignTabs a[data-bs-toggle="pill"]').on('click', function (e) {
                ...
                const currentTab = $('.tab-pane.show.active').attr('id');
                
                // Prevent navigating away from Tab 1 if required fields are not filled
                if (currentTab === 'details-content' && (target === '#advanced-content' || target === '#proxy-content')) {
                    const campaignName = $('input[name="name"]').val().trim();
                    const campaignUrls = $('textarea[name="urls"]').val().trim();
                    
                    if (!campaignName || !campaignUrls) {
                        let missingFields = [];
                        if (!campaignName) missingFields.push('Campaign Name');
                        if (!campaignUrls) missingFields.push('URL');
                        
                        showToast(`Please fill in required fields: ${missingFields.join(', ')} before proceeding.`, 'warning');
                        
                        // Highlight missing fields
                        if (!campaignName) {
                            $('input[name="name"]').addClass('is-invalid');
                            if ($('input[name="name"]').next('.invalid-feedback').length === 0) {
                                $('input[name="name"]').after('<div class="invalid-feedback d-block">Campaign Name is required.</div>');
                            }
                        }
                        if (!campaignUrls) {
                            $('textarea[name="urls"]').addClass('is-invalid');
                            if ($('textarea[name="urls"]').next('.invalid-feedback').length === 0) {
                                $('textarea[name="urls"]').after('<div class="invalid-feedback d-block">At least one URL is required.</div>');
                            }
                        }
                ...
                updateNavigationButtons(target);
            ...
            // Real-time validation for Campaign Name and URL fields
            ...
            $('textarea[name="urls"]').on('input', function() {
                const value = $(this).val().trim();
                if (value) {
                    $(this).removeClass('is-invalid');
                    $(this).next('.invalid-feedback').remove();
            ...
            $('#projectForm').on('submit', function(e) {
                const timingPairs = [
                    { min: 'min_time', max: 'max_time', name: 'Wait Time After Visiting Initial URL' },
                    { min: 'min_task_delay', max: 'max_task_delay', name: 'Delay After Each Visit' }
                ];
            ...
            function updateNavigationButtons(targetTab) {
                // Hide all navigation button groups first
                $('.tab-nav-btn-group').hide();
                
                // Show the appropriate button group
                if (targetTab === '#details-content') {
                    $('#tab1-nav').css('display', 'flex');
                } else if (targetTab === '#advanced-content') {
                    $('#tab2-nav').css('display', 'flex');
                } else if (targetTab === '#proxy-content') {
                    $('#tab3-nav').css('display', 'flex');
                }
            }

            // Tab Navigation - Next/Previous Button Handlers
            $('.btn-next').on('click', function(e) {
                e.preventDefault();
                const nextTabId = $(this).data('next-tab');
                const currentTab = $('.tab-pane.show.active').attr('id');
                
                // Validate Tab 1 (Campaign Details) before moving to next tab
                if (currentTab === 'details-content') {
                    const campaignName = $('input[name="name"]').val().trim();
                    const campaignUrls = $('textarea[name="urls"]').val().trim();
                    
                    // Check if required fields are filled
                    if (!campaignName) {
                        showToast('Please name your Campaign before proceeding to next step.', 'warning');
                        ...
                        // Scroll to the field
                        $('html, body').animate({
                            scrollTop: $('input[name="name"]').offset().top - 150
                        }, 400);
                        return false;
                    }
                    
                    if (!campaignUrls) {
                        showToast('Please add at least one URL before proceeding to next step.', 'warning');
                        $('textarea[name="urls"]').addClass('is-invalid').focus();
                        ...
                        // Scroll to the field
                        $('html, body').animate({
                            scrollTop: $('textarea[name="urls"]').offset().top - 150
                        }, 400);
                        return false;
                    }
                    
                    // Remove validation errors if fields are valid
                    $('input[name="name"]').removeClass('is-invalid').next('.invalid-feedback').remove();
                    $('textarea[name="urls"]').removeClass('is-invalid').next('.invalid-feedback').remove();
                }
                
                // Trigger tab change
                const nextTabLink = $(`#campaignTabs a[href="${nextTabId}"]`);
                if (nextTabLink.length) {
                    ...
                    // Update navigation buttons
                    updateNavigationButtons(nextTabId);
                    
                    // Smooth scroll to top of form
                    $('html, body').animate({
                        scrollTop: $('#campaignTabs').offset().top - 100
                    }, 400);
                }
            });
            ...
            $('.btn-prev').on('click', function(e) {
                ...
                // Trigger tab change
                const prevTabLink = $(`#campaignTabs a[href="${prevTabId}"]`);
                if (prevTabLink.length) {
                    ...
                    // Update navigation buttons
                    updateNavigationButtons(prevTabId);
            ...
            // Show/hide appropriate navigation buttons based on active tab
            $('#campaignTabs a[data-toggle="pill"], #campaignTabs a[data-bs-toggle="pill"]').on('shown.bs.tab', function (e) {
            ...
            const initialTab = $('#campaignTabs a.active').attr('href') || '#details-content';
            updateNavigationButtons(initialTab);
        });
        ...
        $('#toggleCustomProxy').click(function() {
            if ($(this).hasClass('btn--primary')) {
                ...
                // Clear validation errors and re-enable create button when custom proxy is disabled
        ...
        function validateProxyFormat(proxyString) {
            ...
            // Normalize input: handle newlines, commas, and spaces as separators
            let proxies = [];
            ...
            for (let i = 0; i < proxies.length; i++) {
                ...
                if (!ipv4Pattern.test(proxy)) {
                    return { 
                        valid: false, 
                        error: `Invalid proxy format on line ${i + 1}: "${proxy}". Expected IP:PORT or IP:PORT:USERNAME:PASSWORD` 
                    };
                }
                ...
                for (let j = 0; j < 4; j++) {
                    ...
                    if (num < 0 || num > 255) {
                        return { 
                            valid: false, 
                            error: `Invalid IP address on line ${i + 1}: "${proxy}"` 
                        };
                    }
                }
                ...
                if (port < 1 || port > 65535) {
                    return { 
                        valid: false, 
                        error: `Invalid port on line ${i + 1}: "${proxy}". Port must be between 1 and 65535` 
                    };
                }
            }
        ...
        $('#projectForm').submit(function(event) {
            ...
            if (hasInvalidUrl) {
                ...
                $('#createButton').prop('disabled', false).removeClass('btn--disabled').text('Create Campaign');
                return false;
            }
            ...
            $('#createButton').prop('disabled', true).addClass('btn--disabled').text('Creating Campaign, Please wait...');
        });

        // Credit validation for Active Browsers field
        $('input[name="active_users"]').on('input change', function() {
            var inputValue = parseInt($(this).val()) || 0;
            var maxAllowed = parseInt($(this).attr('max')) || 0;
            ...
            if (inputValue > maxAllowed) {
                ...
                // Show error message
                if ($(this).next('.invalid-feedback').length === 0) {
                    $(this).after('<div class="invalid-feedback">Maximum allowed: ' + maxAllowed + ' (Available: ' + availableCredit + ')</div>');
                }
                $('#createButton').prop('disabled', true).addClass('btn--disabled');
            } else {
                $(this).removeClass('is-invalid');
...
@push('style')
    <style>
        ...
        /* ============================================ */
        /* Tab Navigation Styles - Button Style Tabs   */
        /* ============================================ */
        ...
        #campaignTabs .nav-link.active .step-number {
        ...
        /* Only show the active navigation group */
        .tab-nav-btn-group[style*="display: flex"] {
            display: flex !important;
        }
        ...
        .tab-nav-btn-group .btn-prev {
            background: #6c757d;
            border-color: #6c757d;
            color: white;
        }

        .tab-nav-btn-group .btn-prev:hover {
            background: #5a6268;
            border-color: #545b62;
            transform: translateX(-2px);
        }

        .tab-nav-btn-group .btn-next {
            background: #375c6c;
            border-color: #375c6c;
            color: white;
        }

        .tab-nav-btn-group .btn-next:hover {
            background: #2d4a58;
            border-color: #2d4a58;
            transform: translateX(2px);
        }

        .tab-nav-btn-group #createButton {
            min-width: 180px;
        }
