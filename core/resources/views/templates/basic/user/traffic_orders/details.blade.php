...
@section('content')
            ...
            @if ($order->status == 6)
                <div class="dashboard-table__btn">
                    <a href="javascript:void(0)" class="btn btn-outline--base btn--sm text--small playBtn"
                        ...
                        data-url="{{ route('user.web.resume', $order->id) }}">
            ...
            @elseif($order->status == 1)
                <div class="dashboard-table__btn">
                    <a href="javascript:void(0)" class="btn btn-outline--base btn--sm text--small pauseBtn"
                        ...
                        data-url="{{ route('user.web.pause', $order->id) }}">
            ...
            @elseif($order->status == 2 || $order->status == 5)
                <div class="dashboard-table__btn">
                    <a href="javascript:void(0)" class="btn btn-outline--base btn--sm text--small renewBtn"
                        ...
                        data-url="{{ route('user.web.renew', $order->id) }}">
    ...
    <div class="card custom--card">
                    ...
                    <div class="dashboard-w1 bg--primary b-radius--10 box-shadow">
                        ...
                        <div class="details">
                            <div class="desciption">
                                <span class="text--high">@lang('Campaign') <strong>(ID: {{ $order->id }})</strong></span>
                            </div>
                            <div class="numbers">
        ...
        <div class="card-body">
            ...
            <form class="dashboard-form" role="form" method="POST" action="{{ route('user.web.update', $order->id) }}"
                enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="form-group col-md-6">
                        <label class="form--label" style="font-size: 14px;">@lang('Campaign Name')</label>
                        ...
                        <input type="text" name="title" class="form--control form--control-lg"
                            placeholder="Keep it Short and Catchy" value="{{ $order->name }}">
                    </div>
                    <div class="form-group col-md-8">
                        <div class="form-group">
                            <label class="form--label font-weight-bold" for="url"
                                style="font-size: 14px;">@lang('Your URL')
                                <span data-bs-toggle="tooltip" title="@lang('URL of your website, eg: https://website.com/ or https://www.website.com/')" class="vat-fee-info"><i
                                        class="las la-info-circle"></i> </span>
                                <br><small>@lang('We start with this URL')</small></label>
                            @if ($order->traffic_plan == 101 && !empty($order->link) && $order->status != 0)
                        ...
                        <div class="form-group">
                            <label class="form--label font-weight-bold" for="url"
                                ...
                                <span data-bs-toggle="tooltip" title="@lang('URL of your website, eg: https://website.com/page1 or https://www.website.com/page1')" class="vat-fee-info"><i
                                        class="las la-info-circle"></i> </span>
                                <br><small>@lang('We continue navigating to this URL next')</small></label>
                            @if ($order->traffic_plan == 101 && !empty($order->link2) && $order->status != 0)
                        ...
                        <div class="form-group">
                            <label class="form--label font-weight-bold" for="url"
                                style="font-size: 14px;">@lang('Exit URL')
                                <span data-bs-toggle="tooltip" title="@lang('URL of your website, eg: https://website.com/page2 or https://www.website.com/page2')" class="vat-fee-info"><i
                                        class="las la-info-circle"></i> </span>
                                <br><small>@lang('We complete visits with this URL')</small></label>
                            @if ($order->traffic_plan == 101 && !empty($order->link3) && $order->status != 0)
                                <input type="text" name="link3" value="{{ urldecode($order->link3) }}"
                                    class="form--control form--control-lg" readonly
                                    placeholder="URL of your website, eg: https://website.com/page2 or https://www.website.com/page2">
                            @else
                                <input type="text" name="link3" value="{{ urldecode($order->link3) }}"
                                    class="form--control form--control-lg"
                                    placeholder="URL of your website, eg: https://website.com/page2 or https://www.website.com/page2">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        @if ($order->traffic_plan == 101)
                            <input type="number" id="bouncerate_input"
                                ...
                                style="font-size: 14px; width: 125px; display: inline-block;" value="{{ $order->speed }}"
                    ...
                    <div class="row gy-4">
                        <div class="form-group col-md-4">
                            <label class="form--label" style="font-size: 14px;">@lang('Time per Visit')</label>
                            ...
                            <small for="floatingSelect">Total duration of each visit.</small>
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <select class="form--control form--control-lg" id="traffictype" name="traffictype"
                            ...
                            @if ($order->traffic_plan == 101)
                                <option value="1" {{ old('traffictype', $order->tt) == 1 ? 'selected' : '' }}>
                                    @lang('Direct')</option>
                                <option {{ old('traffictype', $order->tt) == 2 ? 'selected' : '' }} disabled="">
                                    @lang('Organic')</option>
                                <option {{ old('traffictype', $order->tt) == 3 ? 'selected' : '' }} disabled="">
                                    @lang('Social')</option>
                                <option {{ old('traffictype', $order->tt) == 4 ? 'selected' : '' }} disabled="">
            ...
            <div class="modal-content">
                ...
                <form method="post" action="" id="from-prevent-multiple-submits">
                    ...
                    <div class="modal-body">
                        <p class="text-muted" style="font-size: 14px;">@lang('Would you like to pause this campaign?')</p>
                        <p class="text-muted" style="font-size: 14px;">@lang('Note: Traffic will be stopped in a while.')</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn--sm btn--dark"
                            data-bs-dismiss="modal">@lang('No')</button>
                        <button type="submit" class="btn btn--sm btn--base" id="btn-save">@lang('Yes')</button>
                    </div>
                </form>
            </div>
        </div>
...
@push('script')
    ...
    <script>
        ...
        fetch("{{ route('user.web_campaign.chart', $order->id) }}")
    ...
    <script>
        ...
        function updateChart() {
            $.ajax({
                url: "{{ route('user.web_campaign.realtime', $order->id) }}",
                type: "GET",
                dataType: "json",
