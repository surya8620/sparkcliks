        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card custom--card">
                    ...
                    <div class="card-body">
                        <form class="dashboard-form" action="{{ route('user.billing.manual.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <x-admin-form identifier="id" identifierValue="{{ $gateway->form_id }}" />
