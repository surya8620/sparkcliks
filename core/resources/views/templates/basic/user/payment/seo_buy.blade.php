            ...
            <form action="{{ route('user.billing.insert') }}" method="post" class="deposit-form">
                    ...
                    <div class="deposit-info mt-4">
                        <div class="deposit-info__title">
                            <p class="text has-icon">@lang('Discount')
                                <span data-bs-toggle="tooltip" title="@lang('Apply the coupon to get discount')" class="discount-info"><i
                ...
                <div class="payment-system-list is-scrollable gateway-option-list">
                    ...
                    <div class="payment-system-list rounded shadow-sm p-4" style="text-align: center;">
                        <div class="alert alert-danger" role="alert" style="font-size: 12px;"><strong>
                                Please Note: SEO Click service is non-refundable. If you wish to try the service, please
                                activate
                                the Trial pack. Once you have subscribed, refunds will not be
                                provided
        ...
        <div class="col-lg-4 mb-4">
            <div class="col-12">
                ...
                <div class="payment-system-list rounded shadow-sm p-4">
                    ...
                    <i class="fas fa-arrow-down text-center" style="font-size: 24px; display: block; margin: auto;"></i>
                    <div class="payment-system-list rounded shadow-sm p-4" style="text-align: center;">
                        <img src="{{ asset('assets/images/click.svg') }}" class="img-fluid w-40" alt="Google Search">
                        <br>
                    ...
                    <hr>
                    <small class="text-danger mb-0">@lang('NOTE: Your website needs to be added in the Google Search Console and keywords needs to be ranked within the top 100.')</small>
                </div>
            </div>
                                ...
                                <div class="card card-deposit text-center">
                                    <div class="card-body card-body-deposit">
                                        ...
                                        <strong class="text--small font-weight-normal text--danger">
                                            Next Credit will be available after
                                        </strong>
        ...
        <div class="col-lg-12 col-md-12 mb-4">
            <div class="card card-deposit text-center">
                <div class="card-body card-body-deposit">
                    ...
                    <img src="{{ asset('assets/images/serp-extra.png') }}" class="img-fluid" style="width: 40%;"
                            alt="Sale"><br>
                    <small class="font-weight-bold text--primary">
                        Extra Credits will be applied automatically for monthly membership packs. No Coupon required.
                    </small>
                </div>
                <div class="card-body text--primary">
                                <hr>
