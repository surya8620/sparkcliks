...
<div class="row mb-none-30">
    ...
    <!-- dashboard-w1 end -->
    <div class="col-xl-2 col-lg-3 col-sm-4 mb-3 mb-lg-0">
...
<div class="row mb-none-30">
    <div class="col-xl-6 col-sm-6 mb-3 mb-lg-0">
        <a href="{{ route('user.realistic.history') }}" class="d-block text-decoration-none" style="color: inherit;">
    ...
    <div class="col-xl-6 col-sm-6 mb-3 mb-lg-0">
        <a href="{{ route('user.realistic.pending') }}" class="d-block text-decoration-none" style="color: inherit;">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
...
<div class="row mb-none-30">
    <div class="col-xl-4 col-sm-6 mb-3 mb-lg-0">
        <a href="{{ route('user.realistic.completed') }}" class="d-block text-decoration-none" style="color: inherit;">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
    ...
    <div class="col-xl-4 col-sm-6 mb-3 mb-lg-0">
        <a href="{{ route('user.realistic.processing') }}" class="d-block text-decoration-none" style="color: inherit;">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
    ...
    <div class="col-xl-4 col-sm-6 mb-3 mb-lg-0">
        <a href="{{ route('user.realistic.paused') }}" class="d-block text-decoration-none" style="color: inherit;">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
...
<div class="modal fade" id="trialModal" tabindex="-1" role="dialog" aria-labelledby="trialModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('user.realistic.nano')}}" method="post" class="resetForm">
                @csrf
...
<script>
    ...
    fetch("{{ route('user.realistic.chart') }}")
...
<script>
    ...
    function updateChart() {
        $.ajax({
            url: "{{ route('user.realistic.realtime') }}",
            type: "GET",
            dataType: "json",
