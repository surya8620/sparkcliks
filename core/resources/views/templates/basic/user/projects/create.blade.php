        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('New Campaign')</h4>
                </div>

                <div class="card-body">
                    <form id="projectForm" action="{{ route('user.campaign.store') }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <button type="button" id="toggleUrlOrder" class="btn btn--primary me-2 w-100" name="url_order">One by One</button>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <select id="search_ext" class="form--control" name="search_engine">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="number" name="min_delay" class="form-control me-2 w-50" placeholder="Min Delay" min="0" value="10">
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="form--label">@lang('Max')<small class="text--base" style="font-size: 0.75rem;">@lang(' (in seconds)')</small></label>
                                <input type="number" name="max_delay" class="form-control me-2 w-50" placeholder="Max Delay" min="0" value="30">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                ...
                                <input type="number" name="active_users" class="form-control me-2 w-50" placeholder="Max Visits" min="1" max="{{auth()->user()->user_limit - auth()->user()->used_limit}}" value="1">
                            </div>
                            <div class="form-group col-sm-4">
                                ...
                                <input type="number" name="max_visits" class="form-control me-2 w-50" placeholder="Max Visits" min="1" value="100">
                            </div>
                            <div class="form-group col-sm-4">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <button type="button" id="toggleFreeProxy" class="btn btn--primary me-2 w-50">Disabled</button>
                                    <input type="hidden" name="free_proxy_enabled" id="free_proxy_enabled" value="0">
                                </div><br>
                                <select id="freeProxyInput" class="form--control w-50" name="free_proxy_country">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <button type="button" id="toggleCustomProxy" class="btn btn--base me-2 w-50">Enabled</button>
                        ...
                        <hr>
                        @if($user->user_limit == $user->used_limit)
                        <div class="d-flex justify-content-center align-items-center">
                            <button id="createButton" class="btn btn-outline--base w-50 h-45 mt-3" type="submit" disabled>@lang('Create')</button>
                        </div>
                        @else
                        <div class="d-flex justify-content-center align-items-center">
                            <button id="createButton" class="btn btn-outline--base w-50 h-45 mt-3" type="submit">@lang('Create')</button>
                        </div>
                        @endif
                    </form>
