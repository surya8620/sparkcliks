        ...
        <div class="row">
            <div class="col-12 position-relative">
                <div class="ribbon-wrapper">
                    <div class="ribbon">@lang(' Paid')</div>
                </div>
                <div class="list--row">
                ...
                <div class="address list--row">
                    <div class="address-to float-left">
                        ...
                        <ul class="list" style="--gap: 0.3rem">
                            ...
                            <li>
                                <div class="list list--row" style="--gap: 0.5rem">
                                    <span>{{ $address['city'] ?? __('') }}</span>, <span>{{ $address['zip'] ?? __('') }}</span>
                                </div>
                            </li>
                            <li>
                                <div class="list list--row" style="--gap: 0.5rem">
                    ...
                    <table class="table">
                        <thead>
                            <tr class="bg-base">
                                ...
                                <th></th>
                                <th class="text-white text-center">@lang('Qty')</th>
                        ...
                        <tbody>
                            <tr class="text-base">
                                ...
                                <td class="fw-bold text-center">{{ showAmount($invoice->price/$invoice->credits) }}</td>
                                <td class="fw-bold text-center">{{ number_format($invoice->discount_percentage, 2) }}% </td>
                                <td class="fw-bold text-end">{{ showAmount($invoice->amount) }}</td>
                            </tr>
                            <tr class="text-base">
                                <td></td>
                                <td></td>
                                ...
                                <td colspan="2">
                                    <small>{{ showAmount($invoice->discount_amount) }}</small>
                                    <br>
                                    <small>{{ showAmount($invoice->charge) }}</small>
                                    <br>
                                    <small>{{ showAmount($invoice->vat) }}</small>
                                    <br>
                                    <span class="h6 fw-bold fs-6">{{ showAmount($invoice->amount + $invoice->charge + $invoice->vat) }}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-striped mt-30">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    {{ showAmt(@$invoice->final_amo) }} {{ __($invoice->method_currency) }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
