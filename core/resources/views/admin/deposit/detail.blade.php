            ...
            <div class="card overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Pack')
                            <span class="fw-bold">{{ ($deposit->plan_name) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Credits')
                            <span class="fw-bold">{{ ($deposit->credits) }}</span>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('GST/VAT')
                            <span class="fw-bold">{{ showAmount($deposit->vat) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Discount -'){{ __($deposit->discount_percentage) }}
                            <span class="fw-bold">{{ showAmount($deposit->discount_amount) }}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Final Amount')
                            <span class="fw-bold">{{ showAmount($deposit->total_price) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('After Rate Conversion')
                            <span class="fw-bold">{{ showAmount($deposit->final_amo, currencyFormat: false) }}
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('GST/VAT#')
                            <span class="fw-bold">{{ ($deposit->vat_num) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Inv#')
                            <span class="fw-bold">{{ ($deposit->inv_num) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Name')
                            <span class="fw-bold">{{ ($deposit->inv_name) }}</span>
                        </li>
			@php
			    $address = json_decode($deposit->address, true);
			@endphp
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Address')
                                <span class="fw-bold">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Company')
                            <span class="fw-bold">{{ ($deposit->company) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('GST/VAT#')
                            <span class="fw-bold">{{ ($deposit->vat_num) }}</span>
