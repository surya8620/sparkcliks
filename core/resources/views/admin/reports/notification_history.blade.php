                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary"
                                                ...
                                                @if ($log->notification_type == 'email') data-message="{{ route('admin.report.email.print', $log->id) }}" @else data-message="{{ $log->message }}" @endif
                                                data-sent_to="{{ $log->sent_to }}"
                                                onclick="openInNewTab(this)"
                                            ><i class="las la-desktop"></i> @lang('Print')</button>
