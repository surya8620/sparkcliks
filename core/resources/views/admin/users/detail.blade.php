        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.report.transaction', $user->id) }}"
                        icon="las la-money-bill-wave-alt" title="Ref Balance" value="{{ showAmount($user->ref_bals) }}"
                        bg="indigo" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.deposit.list', $user->id) }}" icon="las la-wallet"
                        title="Payments" value="{{ showAmount($totalDeposit) }}" bg="8" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6"
                        link="{{ route('admin.report.transaction') }}?search={{ $user->username }}&remark=order"
                        title="Refunded" icon="fas fa-wallet" value="{{ showAmount($totalSpent) }}" bg="6" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.report.transaction', $user->id) }}" title="Transactions"
                        icon="las la-exchange-alt" value="{{ $totalTransaction }}" bg="17" />
                </div>
            </div>
...
@push('breadcrumb-plugins')
    <a class="btn btn-outline--info btn-sm" href="{{ route('admin.users.service', $user->id) }}">
