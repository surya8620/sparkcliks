                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>@lang('Link2')</th>
                                            <td class="text-start">
                                                <a href="{{ empty(parse_url(urldecode($order->link2), PHP_URL_SCHEME)) ? 'https://' : null }}{{ urldecode($order->link2) }}"
                                                    target="_blank">{{ urldecode($order->link2) }}
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>@lang('Link3')</th>
                                            <td class="text-start">
                                                <a href="{{ empty(parse_url(urldecode($order->link3), PHP_URL_SCHEME)) ? 'https://' : null }}{{ urldecode($order->link3) }}"
                                                    target="_blank">{{ urldecode($order->link3) }}
                                                </a>
                                            </td>
                                        </tr>
                                        @if($order->tt == 2)
