                ...
                <form method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                                    ...
                                    <p class="mb-0">
                                        <small>
                                            ...
                                            <i>@lang('Make sure that the')
                                                <span class="fw-bold">@lang('Email Notification') </span> @lang('module is enabled')
                                            </i>
                                        </small>
                                    </p>
                                </div>
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Dripfeed')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, users can use the dripfeed module to order service.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="dripfeed"
                                        @if (gs('dripfeed')) checked @endif>
                                </div>
                            </li>
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Refill')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, admin have to give the service refill if necessary.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="refill"
                                        @if (gs('refill')) checked @endif>
                                </div>
                            </li>
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Cron Job')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, the order information will be updated from the API provider automatically, and the order will also be placed to the API provider automatically.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="cron_status"
                                        @if (gs('cron_status')) checked @endif>
                                </div>
                            </li>
                        </ul>
                    </div>
