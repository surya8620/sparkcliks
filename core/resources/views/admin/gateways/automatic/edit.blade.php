                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border border--primary">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label>@lang('GST/VAT')</label>
                                                            <div class="input-group">
                                                                <input type="number" step="any" class="form-control" name="currency[{{ $currencyIndex }}][vat_charge]" value="{{ getAmount($gatewayCurrency->vat_charge) }}" required>
                                                                <div class="input-group-text">%</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                        <div class="card border border--primary">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label>@lang('GST/VAT Charge')</label>
                                                    <div class="input-group">
                                                        <div class="input-group-text">%</div>
                                                        <input disabled type="number" step="any" class="form-control" name="currency[{{ $currencyIndex }}][vat_charge]" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
