...
class GeneralSettingController extends Controller
{
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->dripfeed        = $request->dripfeed ? Status::ENABLE : Status::DISABLE;
        $general->refill          = $request->refill ? Status::ENABLE : Status::DISABLE;
        $general->cron_status     = $request->cron_status ? Status::ENABLE : Status::DISABLE;
        $general->save();
